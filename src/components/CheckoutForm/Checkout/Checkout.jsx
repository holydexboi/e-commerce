...
const Checkout = ({ cart, order, onCaptureCheckout, error}) => {
    ...
    const Form = () => activeStep === 0 ? <AddressForm checkoutToken={checkoutToken} next={next} /> : <PaymentForm shippingData={shippingData} checkoutToken={checkoutToken} previous={handlePreviousStep} nextStep={handleNextStep} onCaptureCheckout={onCaptureCheckout} timeout={ timeout }/>
