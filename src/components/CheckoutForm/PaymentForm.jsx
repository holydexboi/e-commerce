...
const PaymentForm = ({ checkoutToken, shippingData, previous, onCaptureCheckout, nextStep, timeout }) => {
    ...
    if (error) {
        ...
        const orderData = {
            ...
            shipping: {
                ...
                country_state: shippingData.shippingSubdividsion,
                postal_zip_code: shippingData.zip,
                contry: shippingData.shippingCountry,
            },
